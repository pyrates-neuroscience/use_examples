using LinearAlgebra, DifferentialEquations, NPZ, Plots, CMAEvolutionStrategy
...
res = minimize(objective_func, w, 1.0, lower=lower, upper=upper, popsize=1000, maxiter=1000, ftarget=0, xtol=0.1,
	multi_threading=false, verbosity=1, callback=cb)
...
# save data to file
npzwrite("/Users/rgf3807/PycharmProjects/use_examples/li_fitted.npz", Dict("weight" => C, "y" => y', "fitness" => fbest(res)))
