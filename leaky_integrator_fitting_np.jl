using BlackBoxOptim, LinearAlgebra, DifferentialEquations, NPZ, Plots
...
opt = bbsetup(optim; Method=method, Parameters=w, SearchRange=(-1.1, 1.1), NumDimensions=length(w),
